...
<section class="overflow-hidden py-5 font-poppins ">
...
<br>
  <div class="bg-white max-w-6xl px-4 py-4 mx-auto lg:py-8 md:px-6 border border-gray-300 ">
    ...
    <div class="flex justify-center mb-3"> <img :src="product.data.profil_imageUrl ? product.data.profil_imageUrl : Teamwork " alt="" 
