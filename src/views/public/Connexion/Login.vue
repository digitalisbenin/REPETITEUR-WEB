 ...
 <template>
    ...
    <div >
     ...
     <div class="custom-background h-screen" id="login">
      <br> <br>
      ...
      <div class="w-full bg-white rounded-lg shadow  md:mt-0 sm:max-w-md xl:p-0">
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8 " >
         ...
         <form @submit.prevent="saveStudent">
             <!-- <div class="mb-1">
               ...
               <input type="email"   v-model="model.login.email" id="email" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-lg rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 " placeholder="">
             </div>
             ...
             <div class="mb-2">
              ...
              <input type="number"   v-model="model.login.phone" id="email" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-lg rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 " placeholder="">
            </div> -->
           
          <!-- <div class="mb-1" v-if="!phoneFilled || !model.login.phone" >
            <label for="email" class="block text-start mb-2 text-xl font-medium text-gray-900 dark:text-white">Email</label>
            <input type="email" v-model="model.login.email" id="email" @input="toggleFields" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-lg rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 " placeholder="">
        </div>
        ...
        <div class="mb-2" v-if="!emailFilled || !model.login.email">
            ...
            <input type="number" v-model="model.login.phone" id="phone" @input="toggleFields" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-lg rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 " placeholder="">
        </div> -->
        <div class="mb-1" v-if="!phoneFilled || !model.login.phone">
          <label for="email" class="block text-start mb-2 text-xl font-medium text-gray-900 ">Email</label>
          <input type="email" v-model="model.login.email" id="email" @input="toggleFields" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-lg rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="">
        
      </div>
      
      <div class="mb-2" v-if="!emailFilled || !model.login.email">
          <label for="phone" class="block text-start mb-2 text-xl font-medium text-gray-900 ">Téléphone</label>
          <input type="number" v-model="model.login.phone" id="phone" minlength="8" maxlength="12"  @input="toggleFields" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-lg rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " placeholder="">
          <!-- <span v-if="!isPhoneValid && model.login.phone > 0" class="text-red-500">Le téléphone doit contenir entre 8 et 12 caractères.</span> -->
      </div>
      
      
        
             <div class="mb-1">
               <label for="password" class="block text-start mb-2 text-xl font-medium text-gray-900 ">Mot de passe</label>
               <input type="password" v-model="model.login.password" minlength="8" id="password" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-lg rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="" required> 
                <!-- <span v-if="isPasswordValid" class="text-red-500">Le mot de passe doit contenir au moins 8 caractères.</span> -->
             </div>
        ...
        <a
          ...
          class="text-lg font-medium text-primary-normal hover:underline"
        >
          Mot de passe oublie
        </a>
      </div>
      <br>
             <div class="flex justify-center">
                 ...
                 <button type="submit"   class="text-white bg-green-600 hover:bg-green-400 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-lg px-5 py-2.5 text-center  ">
                  Connexion
                </button>
             ...
             <span class="text-xl font-blue ">
                 ...
                 <!-- <a href="/register" class="font-medium text-green-500 hover:underline dark:text-orange-400">S'inscrire</a> -->
                  <RouterLink class="font-medium text-green-500 hover:underline" to="/register"
    ...
    <div class="flex flex-col md:flex-row justify-between lg:ml-12">
      ...
      <div class="md:w-1/3 mt-4 md:mt-0">
        ...
        <ul>
          ...
          <li><router-link to="/politique-et-conditions" class="hover:text-gray-400 text-lg"  >Politique & Conditions</router-link>
          </li>
        </ul>
      </div>
...
export default {
    ...
    computed: {
    isPhoneValid() {
      return this.model.login.phone.length >= 8 || this.model.login.phone.length <= 12;
    },
    isPasswordValid() {
      return this.model.login.password.length >= 8;
    }
  },
    mounted(){
        this.getrole();
...
.catch(error => {
  ...
  try {
    // console.log(this.model.login.phone);
    // console.log(this.model.login.phone.length);
    // console.log(this.model.login.password);
    // console.log(this.model.login.password.length);
    // if (this.model.login.phone.length < 8 || this.model.login.phone.length > 12) {
    //     alert("Le téléphone doit contenir entre 8 et 12 caractères.");
    //     return;
    //   }
    //   if (this.model.login.password.length < 8) {
