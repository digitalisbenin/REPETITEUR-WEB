...
<!--       
     ...
     <div class="mb-2">
       <label for="name" class="block text-start mb-0 text-lg font-medium text-gray-900 ">Nom Complet</label>
       <input type="text"  v-model="model.name"  id="name" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-lg rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " placeholder="votre nom Complet" required>
     </div>
       <div class="mb-2">
         <label for="email" class="block text-start mb-0 text-lg font-medium text-gray-900 ">Email</label>
         <input type="email"  v-model="model.email" id="email" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-lg rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " placeholder="votre email" required>
       </div>
       <div class="mb-2">
        <label for="email" class="block text-start mb-0 text-lg font-medium text-gray-900">Téléphone</label>
        <input type="number"  v-model="model.phone" id="email" minlength="8" maxlength="12" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-lg rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " placeholder="votre Téléphone" required>
      </div>
       <div class="mb-2">
         <label for="password" class="block text-start mb-0 text-lg font-medium text-gray-900 ">Mot de passe</label>
         <input type="password" v-model="model.password" id="password" minlength="8" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-lg rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " required>
       </div>
