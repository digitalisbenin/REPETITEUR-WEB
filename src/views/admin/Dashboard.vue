<template>
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg bg-white mt-12 p-4">
        ...
        <h3 class="text-3xl font-medium text-gray-900  font-serif text-start"></h3><br>
                    ...
                    <td class="flex items-center px-6 py-4 space-x-3" v-if="apprenant.status === 'Validé'">
                        <!--  <a href="#" wire:click="edit({{ $commande }})" wire:loading.attr="disabled"
                          ...
                          <a href="#" @click="openModal(apprenant.id)"  wire:loading.attr="disabled"
                              class="font-medium text-blue-600 hover:underline">Appréciation</a>
                      </td>
                      <td v-else>
                ...
                <!-- Modal content -->
                    ...
                    <div class="p-4 md:p-5">
                        <form @submit.prevent="savePostes" class="space-y-4" action="#">
                            ...
                            <div>
                                <textarea id="message" v-model="message" rows="4" class="block p-2.5 w-full text-lg text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 " placeholder=" appréciation (Optionnel)" required></textarea>
                            </div> -->
                            <br>
                    ...
                    <div class="p-4 md:p-5">
                        <form @submit.prevent="saveMatiereClasse" class="space-y-4" action="#">
                            ...
                            <div class="col-span-2 sm:col-span-1">
                                     <label for="email" class="block text-start mb-2 text-xl font-medium text-gray-900 ">Matiere</label>
                                <select  id="category" v-model="matiere_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-lg rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5">
                            ...
                            <div class="col-span-2 sm:col-span-1">
                                <label for="email" class="block text-start text-start mb-2 text-xl font-medium text-gray-900 ">Classe</label>
                           <select v-model="classe_id"  id="category" class="bg-gray-50 border border-gray-300 text-gray-900 text-lg rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5">
