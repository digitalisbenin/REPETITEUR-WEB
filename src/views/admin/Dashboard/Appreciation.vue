    ...
    <div class="flex">
      <div class="container mx-auto mt-12 px-5">
        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
          <h3
            class="text-3xl font-medium text-gray-900 font-serif text-start"
          >
          ...
          <div class="flex">
            <div class="flex items-center space-x-4">
              <button
                type="button"
                @click="searchMessage"
                class="inline-flex text-white bg-blue-900 hover:bg-blue-600 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-lg px-5 py-2.5 mr-2 mb-2"
              >
                Tous les messages
              </button>
              <button
                ...
                class="inline-flex text-white bg-yellow-700 hover:bg-yellow-600 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-lg px-5 py-2.5 mr-2 mb-2"
              >
              ...
              <button
                type="button"
                @click="searchRepondu"
                class="inline-flex text-white bg-green-800 hover:bg-green-600 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-lg px-5 py-2.5 mr-20 mb-2"
              >
                Messages Répondus
              </button>
            </div>
            <div class="flex items-center space-x-4 ml-auto">
              <label
                for="countries"
                class="block px-2 mb-2 text-2xl font-medium text-gray-900 "
                >Filtre sur:</label
              >
              <div class="">
                <select
                  ...
                  <div>
                    <div class="flex-1">
                      ...
                      <input
                        ...
                        name="phone"
                        id="phone"
                        class="my-3 bg-gray-50 border border-gray-300 text-gray-900 text-xl rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 "
                        placeholder=""
                        required
                      />
                    </div>
