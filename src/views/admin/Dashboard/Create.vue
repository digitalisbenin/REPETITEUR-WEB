...
<template>
    <div class="">
        ...
        <div class="container w-full mx-auto my-auto " >
            <h3 class="text-3xl font-medium text-gray-900  text-center mt-4 mb-8 font-serif text-start">Formulaire de demande</h3>
            <div class="w-full max px-4 bg-neutral border border-gray-200 rounded-lg shadow sm:p-12 md:p-4 ">
                
                <form class="space-y-6" action="POST" @submit.prevent="saveEnfants" enctype="multipart/form-data">
                    ...
                    <div class="grid gap-6 mb-3 md:grid-cols-2">
                      <div>
                          <label for="email" class="block text-start mb-1 text-xl font-medium text-gray-900">Votre adresse</label>
                          <input type="text" name="email" v-model="adresse" id="email" class="bg-gray-50 mb-0 border border-gray-300 text-gray-900 text-lg rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="adresse" required />
                      </div>
                      <div>
                          <label for="countries" class="block text-start mb-1 text-xl font-medium text-gray-900">Classe</label>
                    ...
                    <!-- <div class="grid gap-6 mb-3 md:grid-cols-2">
                      <div class="">
                        ...
                        <input
                          ...
                          v-model="adresse"
                          id="email"
                          class="bg-gray-50 mb-0 border border-gray-300 text-gray-900 text-lg rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 "
                          placeholder="adresse"
                          required
                        />
                      </div>
                      <div class="">
                        <label for="countries" class="block mb-1 text-start text-2xl font-medium text-gray-900 ">Classe</label>
                    <select id="countries" v-model="classe_id"   @change="getPrix" class="bg-gray-50 border border-gray-300 text-gray-900 text-xl rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " required>
                    ...
                    <div class="grid gap-6 mb-3 md:grid-cols-2">
                        ...
                        <div class="">
                            <label for="countries" class="block mb-2 text-start text-2xl font-medium text-gray-900 ">Matière</label>
                        ...
                        <!-- <div class="flex-1">
                            <label for="phone" class="block  mb-2 px-3 text-2xl font-medium text-gray-900 ">Prix en FCFA</label>
                             <input type="text" readonly  v-model="prix" name="phone"  id="phone" class="bg-gray-50 border border-gray-300 text-gray-900 text-lg rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-1/3 p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 " placeholder=""> 
                             <span class="block w-1/3 text-3xl font-medium text-gray-900 " >FCFA</span>
                        </div> -->
                        <div class="">
                            <label for="phone" class="block mb-2 text-start px-3 text-2xl font-medium text-gray-900 ">Rémumération</label>
                            ...
                            <!-- <span class="text-2xl font-medium text-gray-900">FCFA</span> -->
                            </div>
                    ...
                    <div class="grid gap-6 mb-3 md:grid-cols-2">
                        <div class="flex-1">
                            <label for="phone"  class="block mb-2 text-start px-3 text-2xl font-medium text-gray-900">Matricule du répétiteur</label>
                           <input type="text" @input="getRepetiteur"  v-model="matricule" name="phone" id="phone" class="bg-gray-50 border border-gray-300 text-gray-900 text-xl rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " placeholder="" required>
                        ...
                        <!-- <div class="flex-1">
                            <label for="countries" class="block mb-2 text-2xl font-medium text-gray-900">Répétiteur</label>
                            <select  id="countries" v-model="repetiteur_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-xl rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                        ...
                        <div class="">
                        <label for="phone" class="block text-start mb-2 px-3 text-2xl font-medium text-gray-900">Informations Complémentaires</label>
                            <input type="text"  v-model="adresses" name="phone" id="phone" class="bg-gray-50 border border-gray-300 text-gray-900 text-xl rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="" required>
                        </div>
...
//           this.enfantss_id = response. data.data.id
...
//            axios.post( 'https://apirepetiteur.wadounnou.com/api/demandes',dataToSends,config ).then(res =>{
