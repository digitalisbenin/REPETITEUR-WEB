                        ...
                        <div class="flex-1">
                            ...
                            <div class="flex-1">
                                <label for="phone" class="block text-start mb-2 px-3 text-2xl font-medium text-gray-900 ">Votre Téléphone<span class="text-red-500">*</span></label>
                                    <input type="number"  v-model="phone" name="phone" id="phone" class="bg-gray-50 border border-gray-300 text-gray-900 text-xl rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="" required>
                                </div>
                            ...
                            <div class="flex-1">
                                ...
                                <div class="flex-1">
                                  <label for="phone" class="block text-start mb-2 px-3 text-2xl font-medium text-gray-900 ">Objet</label>
                                      <input type="text"  v-model="objet" name="phone" id="phone" class="bg-gray-50 border border-gray-300 text-gray-900 text-xl rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="" required>
                                  </div>
                    </div>
                    <div class="flex space-x-4">
                        <div class="flex-1">
                            <label for="message" class="block text-start mb-2 text-2xl font-medium text-gray-900 ">Message<span class="text-red-500">*</span></label>
